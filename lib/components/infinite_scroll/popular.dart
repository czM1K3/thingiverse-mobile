...
class InfinitePopular extends StatefulWidget {
  const InfinitePopular({Key? key}) : super(key: key);

  @override
  State<InfinitePopular> createState() => _InfinitePopularState();
}

class _InfinitePopularState extends State<InfinitePopular> {
  ...
  Future<void> _fetchPage(int pageKey) async {
    try {
      final newItems = await _thingiverse.getPopular(page: pageKey);
      if (newItems == null) {
        return;
      }
